...
def read_features(data_root, tmp_root, bbox, list_action):
    ...
    save_data_path = os.path.join(data_root, 'processed', 'hico_data_background_49') # path to save .p model
    feature_path = os.path.join(data_root, 'processed', 'features_background_49')
...
def collect_data(paths):
    ...
    anno_bbox = scipy.io.loadmat(os.path.join(paths.data_root, "hico_20160224_det",'anno_bbox.mat'))
